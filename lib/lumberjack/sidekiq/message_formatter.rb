...
module Lumberjack::Sidekiq
  ...
  class MessageFormatter
    # Initializes the message formatter with Sidekiq configuration.
    #
    ...
    # Filters job arguments based on the worker's logging configuration.
    #
    # @param job [Hash] The job data.
    # @param args [Array] The job arguments.
    # @param args_filter [Array] The list of argument names to include.
    # @return [Array<String>] The filtered and formatted arguments.
